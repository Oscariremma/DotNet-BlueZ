...
namespace subscribeToCharacteristic
{
  ...
  subscribeToCharacteristic 8C:8E:F2:AB:73:76 hci0 CAFE CFFE (see https://github.com/Oscariremma/early-iOS-BluetoothLowEnergy-tests/tree/master/myFirstPeripheral)");
        Console.WriteLine();
